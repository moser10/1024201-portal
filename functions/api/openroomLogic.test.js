...
import { makeRoomCode, parseCreate, canJoin, sanitizeMsg, publicRoom, CODE_ALPHABET } from "./openroomLogic.js";
...
test("create accepts dua or chat with optional pin", () => {
  ...
  assert.deepEqual(ok, { kind: "dua", title: "night", pin: "2048", maxSeats: 2 });
});
